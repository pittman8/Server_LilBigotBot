...
var corsOptions = {
origin: ['http://localhost:4200', 'https://bigotbotclient.azurewebsites.net', 'http://bigotbotclient.azurewebsites.net' ],   // this URL must match the URL that the Angular app will call from
